...
class Add_Note_Windoww(QMainWindow):
    def __init__(self, email, name):
        ...
        try:
            ...
            cursor.execute(f"SELECT id_polzovatel_2, telefon, name FROM polzovatel_2;")
    ...
    def dobavit(self):
        try:
            ...
            c = "insert into polzovatel_2 (id_polzovatel_2, telefon, name) values (" + self.abox1.text() + ", " + self.abox2.text() + ", '" + self.abox3.text() + "');"
            ...
            new_item = QTableWidgetItem("Номер пользователя")
            self.tableWidget.setItem(0, 0, new_item)
            new_item = QTableWidgetItem("Номер телефона")
            self.tableWidget.setItem(0, 1, new_item)
            new_item = QTableWidgetItem("ФИО")
            self.tableWidget.setItem(0, 2, new_item)
